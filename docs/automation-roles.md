...
repository has five or more open generated PRs. Branches or PR titles prefixed
with `kaizen/`, `codex/`, `claude/`, `[scout]`, `[monitor]`, or `kaizen:` count
as generated. Those prefixes count as generated unless there is evidence that they are human-authored maintenance.
